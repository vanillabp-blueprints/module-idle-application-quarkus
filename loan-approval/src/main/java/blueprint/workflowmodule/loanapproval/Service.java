...
public class Service {
  ...
  /**
   * Pays out the loan, which a contract lets the bank do once the withdrawal period is
   * over. A real application would tell a payment system here.
   *
   * @param loanApproval The loan approval to pay out.
   */
