...
public class Aggregate {
  ...
  /**
   * Set by the task behind the timer. It is what tells a reader that the application woke
   * up again: nothing ran while the workflow waited, and then this was written.
   */
  @Column
